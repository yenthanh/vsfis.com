...
(function(a) {
    var b = function(b, c) {
        ...
        if (!d.manualAdvance && g.length > 1) {
            i = setInterval(function() { o(f, g, d, false); }, d.pauseTime);
        }
        if (d.directionNav) {
            ...
            if (d.directionNavHide) {
                ...
                f.hover(function() { a(".nivo-directionNav", f).show(); }, function() { a(".nivo-directionNav", f).hide(); });
            }
        ...
        var o = function(b, c, d, e) {
            ...
            if (g == "sliceDown" || g == "sliceDownRight" || g == "sliceDownLeft") {
                ...
                l.each(function() {
                    ...
                    c.css({ top: "0px" });
                    if (k == d.slices - 1) {
                        setTimeout(function() { c.animate({ height: "100%", opacity: "1.0" }, d.animSpeed, "", function() { b.trigger("nivo:animFinished"); }); }, 100 + j);
                    } else {
                        setTimeout(function() { c.animate({ height: "100%", opacity: "1.0" }, d.animSpeed); }, 100 + j);
                    }
                    j += 50;
                    k++;
                });
                ...
                a(".nivo-slice", b).each(function() {
                    ...
                    if (k == d.slices - 1) {
                        setTimeout(function() { c.animate({ width: e, opacity: "1.0" }, d.animSpeed, "", function() { b.trigger("nivo:animFinished"); }); }, 100 + j);
                    } else {
                        setTimeout(function() { c.animate({ width: e, opacity: "1.0" }, d.animSpeed); }, 100 + j);
                    }
                    j += 50;
                    k++;
                });
                ...
                q.animate({ opacity: "1.0" }, d.animSpeed * 2, "", function() { b.trigger("nivo:animFinished"); });
            } else if (g == "slideInRight") {
                m(b, d, f);
                var q = a(".nivo-slice:first", b);
                q.css({ height: "100%", width: "0px", opacity: "1" });
                q.animate({ width: b.width() + "px" }, d.animSpeed * 2, "", function() { b.trigger("nivo:animFinished"); });
                ...
                s.each(function() {
                    var c = a(this);
                    if (k == r - 1) {
                        setTimeout(function() { c.animate({ opacity: "1" }, d.animSpeed, "", function() { b.trigger("nivo:animFinished"); }); }, 100 + j);
                    } else {
                        setTimeout(function() { c.animate({ opacity: "1" }, d.animSpeed); }, 100 + j);
                    }
                    j += 20;
                    k++;
                });
                    ...
                    for (var y = 0; y < d.boxRows; y++) {
                        if (x >= 0 && x < d.boxCols) {
                            (function(c, e, f, h, i) {
                                ...
                                if (h == i - 1) {
                                    setTimeout(function() { j.animate({ opacity: "1", width: k, height: l }, d.animSpeed / 1.3, "", function() { b.trigger("nivo:animFinished"); }); }, 100 + f);
                                } else {
                                    setTimeout(function() { j.animate({ opacity: "1", width: k, height: l }, d.animSpeed / 1.3); }, 100 + f);
                                }
                            })(y, x, j, k, r);
                            k++;
                        }
        ...
        var q = function(a) { if (this.console && typeof console.log != "undefined") console.log(a); };
        this.stop = function() {
