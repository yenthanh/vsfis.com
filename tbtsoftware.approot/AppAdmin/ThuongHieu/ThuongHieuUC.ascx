<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThuongHieuUC.ascx.cs"
            Inherits="MinhPham.Web.BepNhaBan.AppAdmin.ThuongHieu.ThuongHieuUC" %>
    ...
    <div class="ui-widget-content ui-corner-top ui-corner-bottom">
        <div id="toolbox">
            <div class="header" style="float: left;">
                ...
                <span>Danh sách thương hiệu sản phẩm</span>
            </div>
        ...
        <asp:ListView ID="lv_ThongTinSP" OnItemDeleting="lv_ThongTinSP_ItemDeleting" OnItemCanceling="lv_ThongTinSP_ItemCanceling"
            ...
            <ItemTemplate>
                <tr class="row0">
                    ...
                    <%--Thao tác--%>
                    <td align="center">
                        <asp:LinkButton ID="lbtnDelete" runat="server" OnClientClick=" if (!confirm('Bạn có chắc chắn muốn nhóm chi nhánh này không?')) return false; "
                                        ToolTip="Xóa nhóm chi nhánh" CommandName="Delete">Xóa</asp:LinkButton>
                    </td>
                    <td>
