<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndexUC.ascx.cs"
            Inherits="MinhPham.Web.BepNhaBan.AppAdmin.Article.IndexUC" %>
        ...
        <div id="toolbox">
            ...
            <div style="float: right;">
                <table class="toolbar">
                    <tr>
                        <td align="center">
                            <a href="/AppAdmin/Article/Index.aspx" cssclass="toolbar"><span title="Thêm sản phẩm" class="Icon-32-Add"></span>Thêm mới</a>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <asp:ListView ID="lv_ThongTinSP" OnItemDeleting="lv_ThongTinSP_ItemDeleting" runat="server">
                        ...
                        <table cellspacing="0" border="1" style="border-collapse: collapse; width: 100%;"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th style="width: 15%">Ngôn ngữ
                                    </th>
                                    <th style="width: 20%">Ngày tạo
                                    </th>
            ...
            <ItemTemplate>
                <tr class="row0">
                    ...
                    <td><%#Eval("Language.Name") %>
                    </td>
                         <td><%#Eval("CreatedOnUtc") %>
                    </td>

                    <td class="action">
                        <a href='/AppAdmin/Article/Edit.aspx?id=<%#Eval("ID") %>'><img src="/StyleLibrary/AdminStyles/Toolbox/icon-32-edit.png"></a>
