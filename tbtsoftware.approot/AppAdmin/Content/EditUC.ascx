<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditUC.ascx.cs"
    Inherits="MinhPham.Web.BepNhaBan.AppAdmin.Content.EditUC" %>
...
<div id="iRightAccess" runat="server">
    ...
    <table class="admintable" width="100%">
        <tr>
            <td class="key">
                <span class="Required">*</span>&nbsp;Tên nội dung
            </td>
            <td style="width: 25%">
        ...
        <div id="tabs-1">
            <table class="admintable" width="100%">
                ...
                <tr>
                    ...
                    <td style="width: 25%">
                        <CKEditor:CKEditorControl ID="ckFullvn" BasePath="~/ckeditor" runat="server"></CKEditor:CKEditorControl>
                        <span class="tooltip"><span class="tooltipContent">
                            <p class="tooltiptitle">
                                Danh mục sản phẩm
                            </p>
