<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BranchUC.ascx.cs"
            Inherits="MinhPham.Web.BepNhaBan.AppAdmin.Config.Branch.BranchUC" %>
    ...
    <div class="ui-widget-content ui-corner-top ui-corner-bottom">
        <div id="toolbox">
            <div class="header" style="float: left;">
                ...
                <span>Danh sách chi nhánh công ty</span>
            </div>
