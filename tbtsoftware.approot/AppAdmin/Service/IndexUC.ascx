<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndexUC.ascx.cs"
            Inherits="MinhPham.Web.BepNhaBan.AppAdmin.Service.IndexUC" %>
        ...
        <div id="toolbox">
            ...
            <div style="float: right;">
                <table class="toolbar">
                    <tr>
                        <td align="center">
                            <a href="/AppAdmin/Service/Edit.aspx" cssclass="toolbar"><span title="Thêm sản phẩm" class="Icon-32-Add"></span>Thêm mới</a>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <asp:ListView ID="lv_ThongTinSP" OnItemDeleting="lv_ThongTinSP_ItemDeleting" runat="server">
            ...
            <ItemTemplate>
                <tr class="row0">
                    ...
                    <td class="action">
                        <a href='/AppAdmin/Service/Edit.aspx?id=<%#Eval("ID") %>'><img src="/StyleLibrary/AdminStyles/Toolbox/icon-32-edit.png"></a>
