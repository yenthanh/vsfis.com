<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddUC.ascx.cs"
            Inherits="MinhPham.Web.BepNhaBan.AppAdmin.Menu.AddUC" %>
                ...
                <table class="toolbar">
                    <tr>
                        <td align="center">
                            ...
                            <asp:LinkButton ID="lbtnPublish" runat="server" CssClass="toolbar" OnClick="lbtnPublish_Click"><span title="Lưu và thêm mới danh mục" class="Icon-32-Publish"></span>Lưu và Thêm mới</asp:LinkButton>
                            <asp:LinkButton ID="lbtnSave" CssClass="toolbar" runat="server" OnClick="lbtnSave_Click"><span title="Lưu danh mục" class="Icon-32-Save"></span>Lưu</asp:LinkButton>
            ...
            <table class="admintable" style="width: 100%;">
                <tr>
                    <td class="key" style="width: 150px;">
                        <span class="Required">*</span> Tên menu
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="ckbDisplay" runat="server" Checked="True" Text="Hiển thị" />
                        <span class="tooltip"><span class="tooltipContent">
                                                  <p class="tooltiptitle">
                                                      Hiển thị</p>
                                                  <p class="tooltipmessage">
